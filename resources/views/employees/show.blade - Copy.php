        ...
        <div class="col-md-4">
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center">{{ $employee->designation->name ?? 'N/A' }}</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-2">
                            <a href="{{ route('employees.revisions.create', $employee) }}" class="btn btn-info btn-block"><b>Revise Salary</b></a>
                        </div>
                        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header p-2">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        {{-- ✅ UPDATED: Tabs are now separated for clarity --}}
                        ...
                        <div class="tab-pane" id="employment">
                            <strong><i class="fas fa-building mr-1"></i> Employment Details</strong>
                             <dl class="row mt-2">
                                ...
                                <dd class="col-sm-8">{{ $employee->designation->name ?? 'N/A' }}</dd>
