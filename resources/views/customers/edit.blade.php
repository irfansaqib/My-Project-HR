        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select name="type" id="type" class="form-control" required>
                        ...
                        <option value="Partnership" {{ old('type', $customer->type) == 'Partnership' ? 'selected' : '' }}>Partnership</option>
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="cnic" class="form-control" id="cnic" value="{{ old('cnic', $customer->cnic) }}" required>
                    @error('cnic') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-6 form-group">
                    <label for="contact_person">Contact Person (Optional)</label>
                    <input type="text" name="contact_person" class="form-control" id="contact_person" value="{{ old('contact_person', $customer->contact_person) }}">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="ntn" class="form-control" id="ntn" value="{{ old('ntn', $customer->ntn) }}">
