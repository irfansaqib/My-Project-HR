...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- ✅ FIX: Brand Logo with improved layout -->
        <a href="{{ route('dashboard') }}" class="brand-link text-center" style="background-color: white; color: #343a40 !important; padding: 10px 0; height: auto; line-height: 1.2;">
            <img src="{{ Auth::user()->business && Auth::user()->business->logo_path ? asset('storage/' . Auth::user()->business->logo_path) : asset('adminlte/dist/img/AdminLTELogo.png') }}" alt="Logo" class="brand-image mx-auto d-block" style="opacity: .8; max-height: 40px; width: auto; float: none; border-radius: 0;">
            <span class="brand-text font-weight-light d-block" style="font-size: 0.9rem; margin-top: 5px;">{{ Auth::user()->business->business_name ?? config('app.name', 'Laravel') }}</span>
        </a>
